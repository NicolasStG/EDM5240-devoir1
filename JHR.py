...
for article in articles:
    ...
    if len(article) >=4: ### Très bien! Tu as repéré que certains articles contiennent 3 éléments, d'autres 4!
        media = article[0]
        section = article[1]
        mots = int(article[2].replace("samedi 26 janvier 2019 ", "").replace(" mots", ""))
        page = article[3]
        print("Dans {0} à la {3}, cet article publié dans la section {1} compte {2} mots.".format(media, section, mots, page)) ### Bravo! J'avais omis de vous indiquer qu'on peut préciser l'ordre d'affichage des variables, quand on utilise la méthode .format(), avec un index
    else:
        media = article[0]
        mots = int(article[1].replace("samedi 26 janvier 2019 ", "").replace(" mots", ""))
        page = article[2]
        print("Dans {0} à la {2}, cet article compte {1} mots.".format(media, mots, page))
...
### Très bien! Mais encore mieux: la seconde boucle ci-dessous aurait pu être intégrée dans la première (il aurait fallu alors déplacer la déclaration des variables «lapresse» et autres avant la première boucle)
...
for article in articles:
    ...
    if media == "La Presse+":
        ...
        latribune += 1
    elif media == "La Voix de l'Est":
        lavoix += 1

print("Le 26 janvier 2019, le quotidien La Presse+ a publié " + str(lapresse) + " articles.")
print("Le 26 janvier 2019, le quotidien Le Devoir a publié " + str(ledevoir) + " articles.")
print("Le 26 janvier 2019, le quotidien Le Soleil a publié " + str(lesoleil) + " articles.")
print("Le 26 janvier 2019, le quotidien Le Nouvelliste a publié " + str(lenouvelliste) + " articles.")
print("Le 26 janvier 2019, le quotidien La Tribune a publié " + str(latribune) + " articles.")
print("Le 26 janvier 2019, le quotidien La Voix de l’Est a publié " + str(lavoix) + " articles.")
print("Cette journée-là, le nombre d'article écrit est égal à " + str(lapresse + ledevoir + lesoleil + lenouvelliste + latribune + lavoix) + ".") ### Super ajout! :)

### Au final: excellent script! Bravo!