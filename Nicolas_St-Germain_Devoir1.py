...
for article in articles:
    ...
    if len(article) >=4:
        ...
        page = article[3]
        print("Dans {0} à la {3}, cet article publié dans la section {1} compte {2} mots.".format(media, section, mots, page))
    else:
        media = article[0]
...
print("Cette journée-là, le nombre d'article écrit est égal à " + str(lapresse + ledevoir + lesoleil + lenouvelliste + latribune + lavoix) + ".")